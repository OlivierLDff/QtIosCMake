...
MACRO(add_qt_ios_app TARGET)
    ...
    IF(NOT QT_IOS_CATALOG_APPICON)
        ...
        IF(QT_IOS_VERBOSE)
        MESSAGE(WARNING "CATALOG_APPICON not specified, default to ${QT_IOS_CATALOG_APPICON}.")
        ENDIF(QT_IOS_VERBOSE)
    ...
    IF(NOT QT_IOS_CATALOG_LAUNCHIMAGE)
        ...
        IF(QT_IOS_VERBOSE)
        MESSAGE(WARNING "CATALOG_LAUNCHIMAGE not specified, default to ${QT_IOS_CATALOG_LAUNCHIMAGE}.")
        ENDIF(QT_IOS_VERBOSE)
